...
(setq blame-reveal-recent-days-limit 7          ; Show only last week
      blame-reveal-gradient-quality 'strict)    ; Excellent distinction

;; Inactive legacy project
(setq blame-reveal-recent-days-limit 365        ; Show last year
      blame-reveal-gradient-quality 'relaxed)   ; More history

;; Large monorepo with big files
(setq blame-reveal-lazy-load-threshold 3000     ; Aggressive lazy loading
...
| Slow on large files       | Lower =lazy-load-threshold= (e.g., =2000=)            |
